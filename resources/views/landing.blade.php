    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            Join our cutting-edge logistics team!
          </h1>
          <p class="leading-normal text-2xl mb-1 flex-col">
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50 rounded-xl" src="/images/logo.PNG"/>
        </div>
      </div>
    </div>
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="https://www.facebook.com/LyonsExpressLLC" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Facebook</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="https://www.linkedin.com/company/lyons-express-llc/" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Linkedin</a>
              </li>
            </ul>
          </div>
          <div class="flex-1">
